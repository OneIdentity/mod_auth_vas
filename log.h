...
#else /* C99 */
#   define MAV_LOG_R(level, request, ...) ap_log_rerror(APLOG_MARK, level, OK, request, __VA_ARGS__)
...
#   define MAV_LOG_SERRNO(level, s, error, ...) ap_log_error(APLOG_MARK, level, error, s, __VA_ARGS__)
#   define MAV_LOG_P(level, pool, ...) ap_log_perror(APLOG_MARK, level, OK, pool, __VA_ARGS__)
#   define MAV_LOG_PERRNO(level, pool, error, ...) ap_log_perror(APLOG_MARK, level, error, pool, __VA_ARGS__)
#endif /* __GNUC__ */
...
#else /* C99 */
#   define ERROR_R(r,...)  MAV_LOG_R(APLOG_ERR, r, __VA_ARGS__)
#   define WARN_R(r,...)   MAV_LOG_R(APLOG_WARNING,r,__VA_ARGS__)
#   define DEBUG_R(r,...)  MAV_LOG_R(APLOG_DEBUG, r, __VA_ARGS__)
#   define TRACE1_R(r,...) MAV_LOG_R(APLOG_TRACE1, r, __VA_ARGS__)
#   define TRACE2_R(r,...) MAV_LOG_R(APLOG_TRACE2, r, __VA_ARGS__)
#   define TRACE3_R(r,...) MAV_LOG_R(APLOG_TRACE3, r, __VA_ARGS__)
#   define TRACE4_R(r,...) MAV_LOG_R(APLOG_TRACE4, r, __VA_ARGS__)
#   define TRACE5_R(r,...) MAV_LOG_R(APLOG_TRACE5, r, __VA_ARGS__)
#   define TRACE6_R(r,...) MAV_LOG_R(APLOG_TRACE6, r, __VA_ARGS__)
#   define TRACE7_R(r,...) MAV_LOG_R(APLOG_TRACE7, r, __VA_ARGS__)
#   define TRACE8_R(r,...) MAV_LOG_R(APLOG_TRACE8, r, __VA_ARGS__)

#   define ERROR_S(s,...)  MAV_LOG_S(APLOG_ERR,s,__VA_ARGS__)
#   define WARN_S(s,...)   MAV_LOG_S(APLOG_WARNING,s,__VA_ARGS__)
#   define DEBUG_S(s,...)  MAV_LOG_S(APLOG_DEBUG,s,__VA_ARGS__)
#   define TRACE1_S(s,...) MAV_LOG_S(APLOG_TRACE1,s,__VA_ARGS__)
#   define TRACE2_S(s,...) MAV_LOG_S(APLOG_TRACE2,s,__VA_ARGS__)
#   define TRACE3_S(s,...) MAV_LOG_S(APLOG_TRACE3,s,__VA_ARGS__)
#   define TRACE4_S(s,...) MAV_LOG_S(APLOG_TRACE4,s,__VA_ARGS__)
#   define TRACE5_S(s,...) MAV_LOG_S(APLOG_TRACE5,s,__VA_ARGS__)
#   define TRACE6_S(s,...) MAV_LOG_S(APLOG_TRACE6,s,__VA_ARGS__)
#   define TRACE7_S(s,...) MAV_LOG_S(APLOG_TRACE7,s,__VA_ARGS__)
#   define TRACE8_S(s,...) MAV_LOG_S(APLOG_TRACE8,s,__VA_ARGS__)

#   define ERROR_P(p,...)  MAV_LOG_P(APLOG_ERR,p,__VA_ARGS__)
#   define WARN_P(p,...)   MAV_LOG_P(APLOG_WARNING,p,__VA_ARGS__)
#   define DEBUG_P(p,...)  MAV_LOG_P(APLOG_DEBUG,p,__VA_ARGS__)
#   define TRACE1_P(p,...) MAV_LOG_P(APLOG_TRACE1,p,__VA_ARGS__)
#   define TRACE2_P(p,...) MAV_LOG_P(APLOG_TRACE2,p,__VA_ARGS__)
#   define TRACE3_P(p,...) MAV_LOG_P(APLOG_TRACE3,p,__VA_ARGS__)
#   define TRACE4_P(p,...) MAV_LOG_P(APLOG_TRACE4,p,__VA_ARGS__)
#   define TRACE5_P(p,...) MAV_LOG_P(APLOG_TRACE5,p,__VA_ARGS__)
#   define TRACE6_P(p,...) MAV_LOG_P(APLOG_TRACE6,p,__VA_ARGS__)
#   define TRACE7_P(p,...) MAV_LOG_P(APLOG_TRACE7,p,__VA_ARGS__)
#   define TRACE8_P(p,...) MAV_LOG_P(APLOG_TRACE8,p,__VA_ARGS__)
